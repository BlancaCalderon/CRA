...
g_nominal(gn(GN, Conj, GN)) --> g_nominal(GN), conjuncion(Conj), g_nominal(GN), !.
...
g_verbal(gv(V, GV)) --> verbo(V), g_verbal(GV).                                             %Recursivo
g_verbal(gv(V, GAdj)) --> verbo(V), g_adjetival(GAdj).
g_verbal(gv(V, GN)) --> verbo(V), g_nominal(GN).
g_verbal(gv(V)) --> verbo(V).

%Grupo adjetival
g_adjetival(gadj(Adj, Conj, GAdj)) --> adjetivo(Adj), conjuncion(Conj), g_adjetival(GAdj).  %Recursivo
g_adjetival(gadj(Adj)) --> adjetivo(Adj).

%Grupo adverbial
g_adverbial(gadv(Adv, GAdv)) --> adverbio(Adv), g_adverbial(GAdv).                          %Recursivo
g_adverbial(gadv(Adv)) --> adverbio(Adv).

%Grupo preposicional
g_preposicional(gp(Prep, GN, Conj, GP)) -->  preposicion(Prep), g_nominal(GN), conjuncion(Conj), g_preposicional(GP).     %Recursivo
